<template>
    <div>
        <Box pTitle="Modal form" pSmall="Example of login in modal box">
            <div class="d-flex justify-content-center align-items-center">
                <b-button v-b-modal.modal-1 v-b-tooltip.hover title="Tooltip content">Launch demo modal</b-button>
            </div>
        </Box>
        <b-modal id="modal-1" size="lg" title="BootstrapVue">
            ...
            <div slot="modal-footer" class="row">
                <div class="col">
                    <div class="button">
